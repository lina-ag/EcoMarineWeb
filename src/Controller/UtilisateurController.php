...
final class UtilisateurController extends AbstractController
{
    ...
    public function index(
        ...
        if ($request->isXmlHttpRequest()) {
            return $this->render('utilisateur/_results.html.twig', [
    ...
    public function new(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($existingUser) {
                $this->addFlash('error', 'Cet email est deja utilise par un autre utilisateur.');
            ...
            if (!preg_match('/@gmail\.com$/', $utilisateur->getEmail())) {
                $this->addFlash('error', "L'email doit etre une adresse Gmail (@gmail.com)");
                return $this->render('utilisateur/new.html.twig', [
                    'utilisateur' => $utilisateur,
                    'form' => $form,
                ]);
            ...
            if ($dateNaissance && $dateNaissance >= $today) {
                $this->addFlash('error', "La date de naissance doit etre strictement inferieure a aujourd'hui");
                return $this->render('utilisateur/new.html.twig', [
                    'utilisateur' => $utilisateur,
                    'form' => $form,
                ]);
    ...
    public function edit(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($dateNaissance && $dateNaissance >= $today) {
                $this->addFlash('error', "La date de naissance doit etre strictement inferieure a la date d'aujourd'hui");
                return $this->render('utilisateur/edit.html.twig', [
                    'utilisateur' => $utilisateur,
                    'form' => $form,
                ]);
        ...
        $source = new IteratorCallbackSourceIterator(
            ...
            function (Utilisateur $u) {
                return [
                    ...
                    'Cree le' => $u->getCreatedAt()?->format('d/m/Y H:i'),
                ];
            }
        );
