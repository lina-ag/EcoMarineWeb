...
class Dechet
{
    ...
    public function getId_dechet(): ?int { return $this->id_dechet; }
    public function getIdDechet(): ?int { return $this->id_dechet; }
    ...
    public function setDateSignalement(?\DateTimeInterface $dateSignalement): self { $this->dateSignalement = $dateSignalement; return $this; }
    ...
    public function getAiTypeSuggestion(): ?string { return $this->aiTypeSuggestion; }
    public function setAiTypeSuggestion(?string $aiTypeSuggestion): self { $this->aiTypeSuggestion = $aiTypeSuggestion; return $this; }

    public function getAiConfidence(): ?float { return $this->aiConfidence; }
    public function setAiConfidence(?float $aiConfidence): self { $this->aiConfidence = $aiConfidence; return $this; }
    ...
    public function getWeatherMain(): ?string { return $this->weatherMain; }
    public function setWeatherMain(?string $weatherMain): self { $this->weatherMain = $weatherMain; return $this; }

    public function getWeatherWind(): ?float { return $this->weatherWind; }
    public function setWeatherWind(?float $weatherWind): self { $this->weatherWind = $weatherWind; return $this; }

    public function getPriorityScore(): ?int { return $this->priorityScore; }
    public function setPriorityScore(?int $priorityScore): self { $this->priorityScore = $priorityScore; return $this; }

    public function getPriorityLabel(): ?string { return $this->priorityLabel; }
    public function setPriorityLabel(?string $priorityLabel): self { $this->priorityLabel = $priorityLabel; return $this; }

    public function getRecommendedAction(): ?string { return $this->recommendedAction; }
    public function setRecommendedAction(?string $recommendedAction): self { $this->recommendedAction = $recommendedAction; return $this; }
}