 ...
 */
final class Version20260413134347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE volontaire RENAME INDEX fk_action TO IDX_BB5C9C6B61FB397F');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE volontaire RENAME INDEX idx_bb5c9c6b61fb397f TO fk_action');
